---
name: spec-quality
description: "Evaluates and ensures specifications address alternatives considered, non-goals, blast radius, risk flags, and test strategy before implementation begins. Validates that plans include at least two real alternatives, explicit scope exclusions, downstream impact analysis, concrete risk callouts, and scenario-level test coverage. Use when filling requirements or design notes, writing a spec, planning a feature, creating a project plan, reviewing plan quality, or preparing queue-phase documentation for any MCP work item."
...
These are the required areas of analysis.
