...
```""",
                ...
                ordinal = 0,
                isRequired = true,
                tags = listOf("git", "branch-creation", "workflow-instruction", "commands", "role:queue")
            ),
            TemplateSection(
                templateId = templateId,
...
- Reference: Include task IDs or issue numbers if applicable""",
                ...
                ordinal = 1,
                isRequired = true,
                tags = listOf("implementation", "commits", "workflow", "workflow-instruction", "commands", "role:work")
            ),
            TemplateSection(
                templateId = templateId,
...
- Ready to create PR (see GitHub PR Workflow template)""",
                ...
                ordinal = 2,
                isRequired = true,
                tags = listOf("verification", "finalization", "checklist", "commands", "role:review")
            )
        )
