...
class CreateTaskTool : BaseToolDefinition() {
    ...
    override val description: String = """Creates a task with metadata and optional template application.
        ...
        | templateIds | array | No | - | Templates to apply (use list_templates to discover) |
        ...
        - Tasks can be independent or associated with features/projects
        - Use create_dependency to link related tasks

        Related: update_task, get_task, delete_task, search_tasks, list_templates, create_dependency

        For detailed examples and patterns: task-orchestrator://docs/tools/create-task
    """
