            ...
            mapOf(
                ...
                "data" to JsonObject(
                    mapOf(
                        ...
                        "description" to JsonPrimitive("Search results with pagination"),
                        "properties" to JsonObject(
                            mapOf(
                                "items" to JsonObject(
                                    mapOf(
                                        "type" to JsonPrimitive("array"),
                                        "description" to JsonPrimitive("Array of feature objects matching search criteria"),
                                        "items" to JsonObject(
                                            mapOf(
                                                "type" to JsonPrimitive("object"),
                                                "properties" to JsonObject(
                                ...
                                "total" to JsonObject(mapOf("type" to JsonPrimitive("integer"), "description" to JsonPrimitive("Total number of features matching criteria"))),
