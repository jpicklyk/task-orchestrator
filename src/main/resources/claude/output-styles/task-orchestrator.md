...
description: Communication style for workflow coordination in task orchestration
---
...
**Turn OFF orchestration style:**
```
User: /output-style default
```

**Turn ON orchestration style:**
```
User: /output-style task-orchestrator
```
...
**Version:** 2.1 (lightweight - pure communication style)
