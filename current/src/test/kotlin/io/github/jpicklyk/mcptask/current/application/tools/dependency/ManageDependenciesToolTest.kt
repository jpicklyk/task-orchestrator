...
class ManageDependenciesToolTest {
    ...
    @Test
    fun `create single dependency via dependencies array`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create multiple dependencies via array (batch)`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create with explicit type and unblockAt`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create with shared default type`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create with shared default unblockAt`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create per-dep type overrides shared default`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create via linear pattern`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create via fan-out pattern`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create via fan-in pattern`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create via pattern with shared type`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create fails on cycle detection`(): Unit =
        runBlocking {
            // First create A→B
            tool.execute(
                params(
    ...
    @Test
    fun `create fails on duplicate dependency`(): Unit =
        runBlocking {
            // Create A→B
            tool.execute(
                params(
    ...
    @Test
    fun `create fails with invalid UUID`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
            ...
            assertTrue(
                failures[0]
                    .jsonObject["error"]!!
                    .jsonPrimitive.content
                    .contains("UUID", ignoreCase = true)
            )
        }

    @Test
    fun `create fails with self-reference`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
            ...
            assertTrue(
                failures[0]
                    .jsonObject["error"]!!
                    .jsonPrimitive.content
                    .contains("same item", ignoreCase = true)
            )
        }

    @Test
    fun `create RELATES_TO with unblockAt returns validation error`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
            ...
            assertTrue(
                failures[0]
                    .jsonObject["error"]!!
                    .jsonPrimitive.content
                    .contains("RELATES_TO", ignoreCase = true)
            )
        }

    @Test
    fun `create with invalid dependency type`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `create batch fails atomically on cycle within batch`(): Unit =
        runBlocking {
    ...
    @Test
    fun `create with invalid shared type returns error`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `delete by dependency ID`(): Unit =
        runBlocking {
            ...
            val depId =
                (createResult["data"] as JsonObject)["dependencies"]!!
                    .jsonArray[0]
                    .jsonObject["id"]!!
                    .jsonPrimitive.content
    ...
    @Test
    fun `delete by fromItemId and toItemId`(): Unit =
        runBlocking {
            // Create dependency
            tool.execute(
                params(
    ...
    @Test
    fun `delete by relationship with type filter`(): Unit =
        runBlocking {
    ...
    @Test
    fun `delete all dependencies for an item`(): Unit =
        runBlocking {
    ...
    @Test
    fun `delete non-existent dependency by ID`(): Unit =
        runBlocking {
    ...
    @Test
    fun `delete by relationship with no matching deps`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `userSummary for create`(): Unit =
        runBlocking {
            val result =
                tool.execute(
                    params(
    ...
    @Test
    fun `userSummary for delete`(): Unit =
        runBlocking {
            val summary =
                tool.userSummary(
                    params("operation" to JsonPrimitive("delete")),
