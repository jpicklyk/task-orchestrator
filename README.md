...
- **Unbounded hierarchy depth** — item trees are not capped at depth 3; cycle protection is enforced at the database level via a trigger, and subtree/ancestor traversals (search, ancestor-chain reads) are additionally bounded at 1000 levels, erroring a cyclic or over-deep read instead of hanging
