// =============================================================================
// DEPRECATED — Clockwork v2 Archive
// This module is the legacy v2 MCP Task Orchestrator (Clockwork).
// Preserved for reference only. Active development is in the :current module.
// Build JAR:    ./gradlew :clockwork:jar
// Docker image: docker build --target runtime-v2 .  (requires :clockwork:jar first)
// =============================================================================
...
tasks.test {
    useJUnitPlatform()
    // Run tests with the project root as working directory so that tests that resolve
    // paths like "claude-plugins/clockwork/..." still work from the :clockwork submodule.
